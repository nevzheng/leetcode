...
//}
//
//// This Solution is clean, but it uses a lot of memory as path needs to be
/// copied at each branch / an iterative solution with a stack would be more
/// efficient.
// using PathVec = vector<vector<int>>;
//  void dfs(PathVec& paths, const int& tgt, TreeNode*root, vector<int> path,
//  int sum){
